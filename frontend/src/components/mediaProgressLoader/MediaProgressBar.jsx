...
export default function MediaProgressBar({ isMediaUploading, progress }) {
  ...
  return (
    <div className="w-full bg-muted rounded-full h-1 mt-5 mb-4 relative overflow-hidden">
      <motion.div
      ...
      >
        {progress >= 100 && isMediaUploading && (
          <motion.div
            className="absolute top-0 left-0 right-0 bottom-0 bg-primary/30 overflow-hidden"
            animate={{ x: ["0%", "100%", "0%"] }}
